...
export function CommunityCardClient() {
  ...
  return (
    <div className="flex gap-3">
      ...
      <Button
        ...
        variant="outline"
        className="border-2 border-chabaqa-primary/30 text-chabaqa-primary hover:bg-chabaqa-primary hover:text-white transition-all duration-300 bg-chabaqa-primary/5 backdrop-blur-sm h-11 px-4"
      >
