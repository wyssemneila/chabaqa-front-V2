...
export function CommunitiesGridClient({
  ...
  return (
    <div className="space-y-6">
      {/* Results Header */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 p-5 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 shadow-lg">
      ...
      {communities.length > 0 ? (
        <>
          ...
          {/* Pagination */}
          {totalPages > 1 && (
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 shadow-lg">
              {/* Pagination Info */}
