...
const PILLS = ['No code required', 'Built for MENA creators', 'Arabic & French support', 'Free to start']
    ...
    <section className="py-24 px-6 md:px-10 bg-[var(--bg)]" id="about" aria-label="About Chabaqa">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="reveal-right">
          <div className="text-xs font-bold uppercase tracking-[.1em] text-[var(--p)] mb-4">What is Chabaqa?</div>
          <h2 className="text-[clamp(28px,4vw,44px)] font-black text-[var(--t1)] leading-tight mb-5">What is Chabaqa?</h2>
          <p className="text-[var(--t3)] leading-relaxed mb-7">
            Chabaqa enables individuals to leverage their expertise, regardless of background or access to traditional employment, to build sustainable careers by monetizing their knowledge. We empower creators to connect with global audiences, gain professional recognition, and generate meaningful income from untapped potential.
          </p>
          ...
          <a href={`${APP_URL}/register`} className="inline-flex items-center gap-2 px-7 py-4 rounded-2xl text-sm font-bold text-white bg-[var(--p)] hover:bg-[#6c52f0] hover:-translate-y-[2px] transition-all shadow-[0_8px_24px_rgba(142,120,251,.35)]">
