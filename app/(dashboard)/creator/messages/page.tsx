  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl p-5" style={{ background: 'var(--white)', border: '1px solid var(--bd)' }}>
        <p className="text-[13px] font-bold mb-4" style={{ color: 'var(--t1)' }}>Target Audience</p>
      ...
      <div className="rounded-2xl p-5" style={{ background: 'var(--white)', border: '1px solid var(--bd)' }}>
        <div className="flex items-center justify-between mb-3">
          <p className="text-[13px] font-bold" style={{ color: 'var(--t1)' }}>Message</p>
      ...
      <div className="rounded-2xl overflow-hidden" style={{ background: 'var(--white)', border: '1px solid var(--bd)' }}>
        <div className="px-5 py-4" style={{ borderBottom: '1px solid var(--bd)' }}>
          <p className="text-[13px] font-bold" style={{ color: 'var(--t1)' }}>Broadcast History</p>
        </div>
        {broadcasts.map((b, i) => (
      ...
      <div className="flex items-center gap-4 mb-5">
        ...
        <div className="rounded-2xl px-5 py-3.5 flex items-center gap-3" style={{ background: 'var(--white)', border: '1px solid var(--bd)' }}>
          ...
          <div>
            ...
            <p className="text-[11px]" style={{ color: 'var(--t3)' }}>Total Sent</p>
          </div>
        </div>
          ...
          <div key={rule.id} className="rounded-2xl p-4"
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[12px] leading-relaxed" style={{ color: 'var(--t2)', WebkitLineClamp: 2, display: '-webkit-box', WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                  "{rule.message}"
                </p>
              </div>
              <div className="shrink-0 text-right">
                <p className="text-[14px] font-bold" style={{ color: 'var(--p)' }}>{rule.sent.toLocaleString()}</p>
                <p className="text-[10px]" style={{ color: 'var(--t3)' }}>messages sent</p>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4"
          ...
          <div className="w-full max-w-[500px] rounded-2xl"
            ...
            <div className="px-5 py-4 space-y-4">
              {/* Trigger */}
              <div>
                <label className="block text-[12px] font-medium mb-2" style={{ color: 'var(--t2)' }}>Trigger Event</label>
              ...
              {/* Delay */}
              <div>
                <label className="block text-[12px] font-medium mb-2" style={{ color: 'var(--t2)' }}>Send</label>
              ...
              {/* Message */}
              <div>
                <label className="block text-[12px] font-medium mb-2" style={{ color: 'var(--t2)' }}>Message</label>
                <textarea value={draft.message} onChange={e => setDraft(d => ({ ...d, message: e.target.value }))}
                  rows={3} placeholder="Write the automated message…"
