...
export const TRACKING_INTEGRATION_TEMPLATE = {
  // Module imports
  moduleImports: `
import { TrackingModule } from '@/shared/common/modules/tracking.module';`,
  ...
  // Service imports
  serviceImports: `
import { ContentTrackingService } from '@/shared/common/services/content-tracking.service';
import { TrackableContentType } from '@/shared/schema/content-tracking.schema';`,
