...
import { Resource, ResourceDocument, ResourceType, ArticleContent, VideoContent, GuideContent, ContentElement, GuideSection } from '@/infrastructure/database/schemas/content/resource.schema';
import { CreateResourceDto, CreateArticleContentDto, CreateVideoContentDto, CreateGuideContentDto } from '@/domains/content/resource/dto/create-resource.dto';
