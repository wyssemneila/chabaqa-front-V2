...
export const DEFAULT_CREATOR_PLAN_DOCS = [
  {
    ...
    limits: {
      ...
      aiAgentsMax: 1,
      aiCofounderRunsPerMonth: 10,
      aiKnowledgeReindexPerMonth: 2,
  ...
  },
  {
    ...
    limits: {
      ...
      aiAgentsMax: 3,
      aiCofounderRunsPerMonth: 100,
      aiKnowledgeReindexPerMonth: 10,
      aiStaffChatTurnsPerMonth: 1500,
    },
    features: {
      courses: true,
      products: true,
  ...
  },
  {
    ...
    limits: {
      ...
      aiAgentsMax: 10,
      aiCofounderRunsPerMonth: 500,
      aiKnowledgeReindexPerMonth: 50,
      aiStaffChatTurnsPerMonth: 10000,
    },
    features: {
      courses: true,
      products: true,
