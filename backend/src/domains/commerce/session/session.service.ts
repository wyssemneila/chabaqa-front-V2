...
import { BookSessionDto, ConfirmBookingDto, CancelBookingDto, CompleteSessionDto, UpdateBookingStatusDto } from '@/domains/commerce/session/dto/book-session.dto';
...
import { EmailService, SessionBookingEmailData } from '@/domains/communication/email/email.service';
