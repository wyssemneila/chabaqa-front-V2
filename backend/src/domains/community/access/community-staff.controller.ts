...
import { CommunityPermission, CommunityStaffRole } from '@/shared/permissions';
import { AssignStaffRoleDto, UpdateStaffRoleDto } from '@/domains/community/access/dto/staff.dto';
