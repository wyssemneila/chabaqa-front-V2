...
import { CommunityManagementAccess } from '@/domains/admin/common/decorators/admin-roles.decorator';
import { 
  CommunityFiltersDto, 
...
import { AdminRequest, TimePeriod } from '@/domains/admin/common/interfaces/admin-interfaces';
