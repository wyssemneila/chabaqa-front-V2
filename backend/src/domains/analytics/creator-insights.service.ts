...
import { validateCreatorInsightsResponse, type CreatorInsightsResponse } from '@/domains/analytics/creator-insights.validator';
      ...
      try {
        ...
        if (isUnsupportedImageInputError(error)) {
          throw new HttpException(
            {
              success: false,
              message: getUnsupportedImageInputMessage(),
            },
